...
loader.load('./A_sketch_no_holes.stl', (geometry) => {
  ...
  // Model's extrusion (thin) axis came in along X, letter width along Z, height along Y.
  // Rotate so the letter faces the camera (extrusion depth along Z) and reads upright.
