...
const spotConfigs = [
  { top: 4,  left: 3,  w: 19, h: 15, variant: 1, dur: 24, delay: -3  },
  { top: 22, left: 16, w: 11, h: 14, variant: 2, dur: 27, delay: -9  },
  { top: 8,  left: 30, w: 24, h: 10, variant: 3, dur: 21, delay: -5  },
  { top: 34, left: 5,  w: 9,  h: 8,  variant: 4, dur: 26, delay: -14 },
  { top: 48, left: 20, w: 16, h: 20, variant: 5, dur: 30, delay: -2  },
  { top: 58, left: 2,  w: 22, h: 12, variant: 1, dur: 23, delay: -11 },
  { top: 12, left: 55, w: 14, h: 18, variant: 2, dur: 29, delay: -7  },
  { top: 6,  left: 74, w: 18, h: 9,  variant: 3, dur: 25, delay: -16 },
  { top: 40, left: 62, w: 8,  h: 9,  variant: 4, dur: 22, delay: -4  },
  { top: 52, left: 45, w: 21, h: 15, variant: 5, dur: 28, delay: -19 },
  { top: 70, left: 12, w: 13, h: 11, variant: 1, dur: 24, delay: -6  },
  { top: 66, left: 68, w: 17, h: 22, variant: 2, dur: 31, delay: -13 },
  { top: 78, left: 34, w: 10, h: 9,  variant: 3, dur: 20, delay: -17 },
  { top: 80, left: 82, w: 14, h: 13, variant: 4, dur: 27, delay: -8  },
  { top: 26, left: 84, w: 9,  h: 12, variant: 5, dur: 23, delay: -21 },
];
...
nextTab.addEventListener('click', () => {
  pageHome.classList.add('slide-up');
  pageNext.classList.add('reveal');
});

backTab.addEventListener('click', () => {
  pageHome.classList.remove('slide-up');
  pageNext.classList.remove('reveal');
});
